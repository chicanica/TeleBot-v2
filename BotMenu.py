...
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать случайного пользователя", "Прислать анекдот c anekdotme.ru", "Прислать анекдот c nekdo.ru",  "Выход"], parent=m_main)